    ...
    <div className="relative">
      ...
      >
        <span className="mr-3 overflow-hidden rounded-full h-11 w-11">
          {profilePic.includes("default-avatar.png") ? (
            <div className="flex h-full w-full items-center justify-center bg-gray-200 text-sm font-bold text-gray-600 dark:bg-gray-700 dark:text-gray-300">
              {initials}
            </div>
          ) : (
            <img
